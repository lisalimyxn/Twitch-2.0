...
const Index = () => {
  ...
  const [activeChannel, setActiveChannel] = useState("iShowSpeed");
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            {page === "stream" && (
              <StreamPage
                ...
                hasCommerce={["iShowSpeed", "GamerGirl_Pro", "TechReviewer", "ArtistLive", "FashionFwd"].includes(activeChannel)}
              />
            )}
